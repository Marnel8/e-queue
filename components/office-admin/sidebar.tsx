...
const navigation = [
  ...
  { name: "Service Management", href: "/office-admin/services", icon: ClipboardList },
  { name: "Queue Lanes", href: "/office-admin/queues", icon: BarChart3 },
  { name: "Feedback Forms", href: "/office-admin/feedback", icon: MessageSquare },
  { name: "Announcements", href: "/office-admin/announcements", icon: Megaphone },
...
export function OfficeAdminSidebar({ collapsed, onToggle, mobile = false }: SidebarProps) {
              ...
              <li key={item.name}>
                <Link
                  ...
                  className={cn(
                    ...
                    isActive ? "bg-[#071952] text-white" : "text-gray-600 hover:text-[#071952] hover:bg-gray-100",
                  )}
                >
        ...
        {!collapsed && (
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 truncate">Office Administrator</p>
            </div>
          </div>
        )}
        <Button
