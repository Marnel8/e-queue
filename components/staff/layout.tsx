...
export function StaffLayout({ children, title, description }: StaffLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        <StaffSidebar collapsed={sidebarCollapsed} onToggle={() => setSidebarCollapsed(!sidebarCollapsed)} />
      </div>
      ...
      >
        <StaffSidebar collapsed={false} onToggle={() => setMobileMenuOpen(false)} isMobile={true} />
      </div>
      ...
      <div className="lg:hidden">
        <StaffSidebar collapsed={false} onToggle={() => {}} isBottomNav={true} />
      </div>
    </div>
  )
}