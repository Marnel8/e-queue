...
const navigation = [
  ...
  { name: "Book Ticket", href: "/customer/book", icon: Calendar },
...
export function CustomerSidebar({ collapsed, onToggle, isMobile = false, isBottomNav = false }: SidebarProps) {
        ...
        <div className="flex items-center justify-between">
          {(!collapsed || isMobile) && (
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-semibold text-primary">E-Queue</h2>
        ...
        {(!collapsed || isMobile) && (
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-muted-foreground truncate">Student ID: 2024-001234</p>
            </div>
          </div>
        )}
        <Button
