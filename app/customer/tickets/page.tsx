...
import { Download, X, Calendar, Clock, Ticket, CheckCircle, AlertCircle } from "lucide-react"
...
export default function MyTickets() {
  return (
    <CustomerLayout title="My Tickets" description="View and manage your queue tickets">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-xl sm:text-2xl font-bold text-green-600">{activeTickets.length}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-xl sm:text-2xl font-bold text-blue-600">{upcomingTickets.length}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-xl sm:text-2xl font-bold">{completedTickets.length}</div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {activeTickets.map((ticket) => (
                      <div key={ticket.id} className="border rounded-lg p-4 bg-green-50 border-green-200">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 text-xs sm:text-sm">
                          ...
                          <div className="flex items-center gap-2">
                            <span className="font-medium">Fee: {ticket.fee}</span>
                          </div>
                        </div>
                    ...
                    {upcomingTickets.map((ticket) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <Badge className={getStatusBadge(ticket.status)} className="text-xs">
                                {ticket.status}
                              </Badge>
                            </div>
                        ...
                        <div className="text-left sm:text-right">
                          ...
                          <p className="text-sm text-muted-foreground">Fee: {ticket.fee}</p>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            {activeTickets.length === 0 && upcomingTickets.length === 0 && (
              <Card>
                <CardContent className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-6">You don't have any active or upcoming tickets.</p>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-muted-foreground">Completed: {ticket.completedAt}</p>
                        </div>
                      </div>
          ...
          <TabsContent value="cancelled">
            <Card>
              <CardContent className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold mb-2">No Cancelled Tickets</h3>
                <p className="text-muted-foreground">You haven't cancelled any tickets recently.</p>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
