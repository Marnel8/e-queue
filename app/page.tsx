				...
				<div className="container mx-auto px-4 py-4 flex items-center justify-between">
					...
					<div className="flex items-center gap-2 md:gap-3">
						<Link href="/login">
							<Button
								variant="ghost"
								className="text-primary hover:text-primary/80 text-sm md:text-base px-3 md:px-4"
							>
								Login
							</Button>
						</Link>
						<Link href="/register">
							<Button className="gradient-primary text-white text-sm md:text-base px-3 md:px-4">
								Get Started
							</Button>
						</Link>
					</div>
				...
				<div className="container mx-auto px-4 relative z-10">
					<div className="max-w-4xl mx-auto text-center">
						...
						<p className="text-base md:text-xl text-muted-foreground mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed px-4">
							Eliminate long waits and disorganized queues at OMSC Mamburao
							Campus. Experience efficient, real-time queue management with
							smart notifications.
						</p>
				...
				<div className="container mx-auto px-4">
					<div className="flex flex-col md:flex-row items-center justify-between gap-4">
						...
						<p className="text-white/70 text-xs md:text-sm">
							© 2024 E-Queue. All rights reserved.
						</p>
					</div>
				</div>
			</footer>
