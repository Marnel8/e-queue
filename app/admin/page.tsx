...
import { Users, Building2, Clock, TrendingUp, AlertTriangle, CheckCircle, BarChart3, Settings } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="border-0 shadow-sm hover:shadow-md transition-all duration-200 bg-gradient-to-br from-white to-gray-50/50">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
            <CardTitle className="text-sm font-semibold text-gray-600">Active Offices</CardTitle>
          ...
          <CardContent className="pt-0">
            ...
            <p className="text-sm text-gray-500 flex items-center gap-1">
              <span className="text-emerald-600 font-medium">+2</span> new this month
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-sm hover:shadow-md transition-all duration-200 bg-gradient-to-br from-white to-gray-50/50">
          ...
          <CardContent className="pt-0">
            ...
            <p className="text-sm text-gray-500 flex items-center gap-1">
              <span className="text-emerald-600 font-medium">-2.3m</span> from last week
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-sm hover:shadow-md transition-all duration-200 bg-gradient-to-br from-white to-gray-50/50">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
            <CardTitle className="text-sm font-semibold text-gray-600">Queue Efficiency</CardTitle>
          ...
          <CardContent className="pt-0">
            ...
            <p className="text-sm text-gray-500 flex items-center gap-1">
              <span className="text-emerald-600 font-medium">+1.8%</span> improvement
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader className="pb-4">
            <CardTitle className="text-lg font-semibold text-[#071952]">System Status</CardTitle>
            <CardDescription className="text-gray-500">Current system health and performance</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between p-3 bg-amber-50 rounded-lg border border-amber-100">
              ...
              <Badge className="bg-amber-100 text-amber-700 hover:bg-amber-100 border-amber-200">Warning</Badge>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-emerald-50 rounded-lg border border-emerald-100">
              ...
              <Badge className="bg-emerald-100 text-emerald-700 hover:bg-emerald-100 border-emerald-200">Secure</Badge>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader className="pb-4">
            <CardTitle className="text-lg font-semibold text-[#071952]">Recent Activity</CardTitle>
            <CardDescription className="text-gray-500">Latest system events and user actions</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-900">New office registered</p>
                  <p className="text-xs text-gray-500 mt-1">Student Affairs Office - 2 minutes ago</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Maria Santos to Registrar Office - 15 minutes ago</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Database optimization - 1 hour ago</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-900">User account suspended</p>
                  <p className="text-xs text-gray-500 mt-1">Violation of terms - 2 hours ago</p>
                </div>
              </div>
            </div>
          </CardContent>
      ...
      <Card className="border-0 shadow-sm">
        <CardHeader className="pb-4">
          <CardTitle className="text-lg font-semibold text-[#071952]">Office Performance Overview</CardTitle>
          <CardDescription className="text-gray-500">Queue efficiency and service metrics by office</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="space-y-3 p-4 bg-gray-50 rounded-lg">
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium text-gray-700">Registrar Office</span>
            ...
            <div className="space-y-3 p-4 bg-gray-50 rounded-lg">
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium text-gray-700">Cashier Office</span>
            ...
            <div className="space-y-3 p-4 bg-gray-50 rounded-lg">
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium text-gray-700">Student Affairs</span>
            ...
            <div className="space-y-3 p-4 bg-gray-50 rounded-lg">
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium text-gray-700">Guidance Office</span>
      ...
      <Card className="border-0 shadow-sm">
        <CardHeader className="pb-4">
          <CardTitle className="text-lg font-semibold text-[#071952]">Quick Actions</CardTitle>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700">New Office</span>
            </Button>
