...
const feedbackData = [
	...
	},
	{
		...
		rating: 2,
		comment:
			"Long waiting time and the process was confusing. Need better guidance for new students.",
	...
	},
	{
		...
		rating: 3,
		comment:
			"Average service. The process was okay but could be faster. Staff was polite.",
...
const getSentimentBadge = (sentiment: string) => {
	...
	return (
		variants[sentiment as keyof typeof variants] || "bg-gray-100 text-gray-800"
	);
};
			...
			<div className="space-y-6">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Filter feedback by service, rating, or date
						</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="flex flex-col sm:flex-row gap-4">
							<div className="relative flex-1 min-w-0">
								...
								<Input type="text" placeholder="Search feedback..." className="pl-10" />
							</div>
						...
						<div className="space-y-4">
							{feedbackData.map((feedback) => (
								...
								>
											...
											<div className="min-w-0 flex-1">
												...
												<div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
													...
													<span className="text-xs text-muted-foreground truncate">
														Served by: {feedback.staffMember}
													</span>
												</div>
											</div>
										</div>
									...
									<p className="text-sm text-muted-foreground pl-0 sm:pl-13">
										{feedback.comment}
									</p>
