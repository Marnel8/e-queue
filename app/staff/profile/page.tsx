					...
					<div className="flex flex-col lg:flex-row items-start lg:items-center gap-6">
						...
						<div className="flex flex-col sm:flex-row items-center gap-4">
							<div className="relative">
								<Avatar className="w-24 h-24 sm:w-32 sm:h-32 border-4 border-white shadow-lg">
									...
									<AvatarFallback className="bg-[#088395] text-white text-2xl font-bold">
										{staffProfile.firstName[0]}
										{staffProfile.lastName[0]}
									</AvatarFallback>
								</Avatar>
								<Button
									size="sm"
							...
							<div className="text-center sm:text-left">
								...
								<p className="text-lg text-[#088395] font-medium">
								...
								<div className="flex items-center justify-center sm:justify-start gap-2 mt-2">
									<Badge className="bg-[#37B7C3] text-white">
										Employee ID: {staffProfile.employeeId}
									</Badge>
								</div>
							</div>
						</div>
				...
				<div className="lg:col-span-2 space-y-6">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Your professional skills and language proficiencies
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
							<div>
								...
								<div className="flex flex-wrap gap-2">
									{staffProfile.skills.map((skill, index) => (
										<Badge
											key={index}
											variant="outline"
											className="bg-[#EBF4F6] text-[#071952] border-[#37B7C3]"
										>
											{skill}
										</Badge>
									))}
						...
						<CardContent className="space-y-4">
							...
							<div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
								...
								<div>
									...
									<p className="font-medium">
										{staffProfile.schedule.workHours}
									</p>
								</div>
							</div>
						</CardContent>
					...
					<Card>
						...
						<CardContent className="space-y-3">
							...
							<div className="space-y-2">
								...
								<p className="text-sm text-gray-600">
									{staffProfile.schedule.breakTime}
								</p>
							</div>
						</CardContent>
					</Card>
