...
import { Users, Clock, TrendingUp, MessageSquare, Star, ThumbsUp, ThumbsDown, AlertCircle } from "lucide-react"
...
const recentFeedback = [
  {
    ...
    rating: 5,
    comment: "Very efficient service! The staff was helpful and the process was quick.",
  ...
  },
  {
    ...
    service: "Enrollment",
    rating: 2,
    comment: "Long waiting time and confusing process. Staff needs better training.",
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="space-y-2">
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#071952]">Dashboard</h1>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4 sm:space-y-6">
            ...
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground">Based on 345 reviews this month</p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 pt-4 border-t">
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 mb-1">
                  ...
                  <span className="text-sm sm:text-lg font-bold text-green-600">89%</span>
                </div>
              ...
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 mb-1">
                  ...
                  <span className="text-sm sm:text-lg font-bold text-gray-600">8%</span>
                </div>
              ...
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 mb-1">
                  ...
                  <span className="text-sm sm:text-lg font-bold text-red-600">3%</span>
                </div>
        ...
        <Card>
          <CardHeader className="pb-4">
            <CardTitle className="text-base sm:text-lg">Recent Customer Feedback</CardTitle>
            <CardDescription className="text-xs sm:text-sm">Latest reviews and comments from customers</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3 sm:space-y-4">
              {recentFeedback.map((feedback) => (
                <div key={feedback.id} className="border rounded-lg p-3 sm:p-4 space-y-2">
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-2 min-w-0 flex-1">
                      <span className="font-medium text-xs sm:text-sm truncate">{feedback.customer}</span>
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground line-clamp-2">{feedback.comment}</p>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-muted-foreground">{feedback.date}</span>
                    <Badge variant={feedback.sentiment === "positive" ? "default" : "destructive"} className="text-xs">
                      {feedback.sentiment}
                    </Badge>
                  </div>
                </div>
            ...
            <Button variant="outline" className="w-full mt-4 bg-transparent text-xs sm:text-sm">
              View All Feedback
            </Button>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-xs sm:text-sm">Performance metrics for each service offered</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Avg. 4.2 min wait time</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Avg. 6.8 min wait time</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Avg. 12.3 min wait time</p>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-xs sm:text-sm">Common office management tasks</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <Button variant="outline" className="h-16 sm:h-20 flex flex-col gap-1 sm:gap-2 bg-transparent">
