...
export default function ProfilePage() {
  ...
  const profileData = {
    ...
    permissions: ["Manage Staff", "View Reports", "Manage Services", "Handle Feedback", "Create Announcements"],
  }
        ...
        <CardContent className="p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            <Avatar className="w-20 h-20">
              ...
              <AvatarFallback className="bg-[#088395] text-white text-xl">MS</AvatarFallback>
            </Avatar>
            <div className="flex-1 space-y-2">
              <div className="flex items-center gap-3">
                <h2 className="text-xl font-semibold text-gray-900">{profileData.name}</h2>
                <Badge className="bg-[#088395] text-white">{profileData.position}</Badge>
              </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="bio" defaultValue={profileData.bio} className="min-h-20" />
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="employeeId" defaultValue={profileData.employeeId} disabled />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="position">Position</Label>
                  <Input id="position" defaultValue={profileData.position} disabled />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="dateJoined"
                    defaultValue={new Date(profileData.dateJoined).toLocaleDateString()}
                    disabled
                  />
                </div>
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Notifications about queue status</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Notifications about staff changes</p>
                  </div>
                </div>
                <input type="checkbox" defaultChecked className="rounded" />
              </div>
